...
<h4 className="title-2" id='responsive-text-project-heading'>Plans</h4>
						...
						<div className="ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center---" >
							...
							<a className="active show" data-bs-toggle="tab" href="#liton_tab_3_2">All Projects</a>
							<a data-bs-toggle="tab" href="#liton_tab_3_3" >Architecture Designs</a>
							<a data-bs-toggle="tab" href="#liton_tab_3_4" >GCommercial Interior Design</a>
							<a data-bs-toggle="tab" href="#liton_tab_3_5" >Interior Designs</a>
							</div>
						</div>
